...
// build/dev/javascript/linktri/linktri.mjs
...
function init2(_) {
  ...
  return [new Model2(links), void 0];
}
  ...
  let link_elements = map(
    ...
    (link) => {
      return a(
        ...
        toList([text2(link.title)])
      );
    }
  );
  return div(toList([style(styles())]), link_elements);
}
function main() {
